...
public class HelpCommand extends SlashCommand {
    ...
    static Map<String, Map<?, ?>> categories = new HashMap<>();
    static Map<String, Object> settings = new HashMap<>();
    static Map<String, SlashCommand> slashCommandMap = new HashMap<>();
    ...
    public static void initCommands() {
        for (SlashCommand command : DiaBot.getCommandClient().getSlashCommands()) {
