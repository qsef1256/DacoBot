...
@Slf4j
@Component
public class DeleteButton extends DacoButton {

    private final UserController userController;

    protected DeleteButton(@NotNull UserController userController) {
    ...
    protected void runButton(@NotNull ButtonInteractionEvent event) {
        ...
        try {
            ...
            log.error("Failed to delete user account %s(%s)".formatted(
                    user.getName(),
                    user.getIdLong()), e);
        }
